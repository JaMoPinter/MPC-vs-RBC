...
class BaseOptimizer(ABC):
    ...
    def __init__(self, battery_cfg: dict, mpc_freq: int, price_cfg: dict = None):
        """
        ...
        self.t = mpc_freq / 60  # Convert minutes to hours
        ...
        self.mu_charge = self.battery_cfg['charge_efficiency']
        self.mu_discharge = self.battery_cfg['discharge_efficiency']
